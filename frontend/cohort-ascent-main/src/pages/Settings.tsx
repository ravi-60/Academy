...
const tabs: { id: SettingsTab; label: string; icon: React.ElementType; description: string }[] = [
  { id: 'profile', label: 'Identity Profile', icon: UserIcon, description: 'Manage personal credentials' },
  { id: 'notifications', label: 'Alert Matrix', icon: Bell, description: 'Configure notification nodes' },
  { id: 'security', label: 'Firewall & Access', icon: Shield, description: 'Secure access protocols' },
  { id: 'system', label: 'Core Engine', icon: Database, description: 'System-wide configurations' },
];
      ...
      <section className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 p-8 lg:p-12 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight text-white focus:outline-none">
    ...
    <GlassCard className="p-8 lg:p-10 border-border/10 overflow-hidden relative group">
      ...
      <div className="flex items-center gap-6 mb-10">
        <div className="relative">
          <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-primary to-secondary blur opacity-30 animate-pulse" />
          <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-slate-900 border-2 border-white/10 text-3xl font-bold text-white shadow-2xl">
            {user?.name?.charAt(0)}
          </div>
          <button className="absolute -bottom-1 -right-1 h-8 w-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-lg border-2 border-slate-900 hover:scale-110 transition-transform">
